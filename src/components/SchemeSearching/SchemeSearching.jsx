...
const SearchScheme = () => {
  ...
  const schemeTypes = ["All", ...new Set(schemesData.map(scheme => scheme.type))];
    ...
    <div data-aos="fade" className={styles.container}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>
          Explore various government schemes designed for citizen welfare and national development
        </p>
      </div>
      ...
      <div className={styles.resultsInfo}>
        <p className={styles.resultsCount}>
          Showing {filteredAndSortedSchemes.length} of {schemesData.length} schemes
        ...
        {filteredAndSortedSchemes.map((scheme) => (
          ...
          >
            <div className={styles.cardHeader}>
              <div className={styles.iconContainer} style={{ backgroundColor: scheme.color }}>
                <span className={styles.schemeIcon}>{scheme.icon}</span>
              </div>
              <div className={styles.typeBadge} style={{ backgroundColor: scheme.color }}>
                {scheme.type}
              </div>
            </div>
            ...
            <div className={styles.cardGlow} style={{ backgroundColor: scheme.color }}></div>
          </div>
        ))}
      </div>
